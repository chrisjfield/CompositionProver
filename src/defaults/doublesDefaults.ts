...
const doubles: IStage = {
    methods: [
        { methodId: 1, methodSymbol: 'pb', methodName: 'Plain Bob', methodPlaceNotation: 'X.15.X.15.X.15.X.15.X.12', coreMethod: true },
        { methodId: 2, methodSymbol: 'og', methodName: 'Original', methodPlaceNotation: 'X.15.X.15.X.15.X.15.X.15', coreMethod: true },
    ],
    calls: [
